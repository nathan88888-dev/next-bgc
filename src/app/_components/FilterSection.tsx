  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-gray-900">{t('directory.filter_labels.title')}</h3>
        {activeFiltersCount > 0 && (
          ...
          >
            <X className="w-4 h-4" />
            <span>{t('directory.filter_labels.clear_all', { count: activeFiltersCount })}</span>
          </button>
        )}
      </div>
      ...
      <div className="mb-6">
        ...
        >
          <span className="font-medium text-gray-900">{t('directory.filter_labels.tags')}</span>
      ...
      <div className="mb-6">
        <button
          ...
          className="flex items-center justify-between w-full mb-3"
        >
          <span className="font-medium text-gray-900">{t('directory.filter_labels.group_type')}</span>
      ...
      <div className="mb-6">
        <button
          ...
          className="flex items-center justify-between w-full mb-3"
        >
          <span className="font-medium text-gray-900">{t('directory.filter_labels.privacy')}</span>
      ...
      <div className="mb-6">
        <button
          ...
          className="flex items-center justify-between w-full mb-3"
        >
          <span className="font-medium text-gray-900">{t('directory.filter_labels.group_size')}</span>
          ...
          <div className="space-y-2 pl-1">
            {groupSizeOptions.map((option) => (
              <label key={option.value} className="flex items-center space-x-2 cursor-pointer group">
                ...
                />
                <span className="text-sm text-gray-700 group-hover:text-gray-900">
                  {t(`enums.group_size.${option.value}`)}
                </span>
              </label>
            ))}
          </div>
      ...
      <div className="mb-6">
        <button
          ...
          className="flex items-center justify-between w-full mb-3"
        >
          <span className="font-medium text-gray-900">{t('directory.filter_labels.meeting_frequency')}</span>
      ...
      <div className="mb-6">
        <button
          ...
          className="flex items-center justify-between w-full mb-3"
        >
          <span className="font-medium text-gray-900">{t('directory.filter_labels.experience_level')}</span>
      ...
      <div>
        <button
          ...
          className="flex items-center justify-between w-full mb-3"
        >
          <span className="font-medium text-gray-900">{t('directory.filter_labels.language')}</span>
            ...
            {languageOptions.map((option) => (
              <label key={option} className="flex items-center space-x-2 cursor-pointer group">
                <input
                  ...
                  onChange={(e) =>
                    handleCheckboxChange('languages', option, e.target.checked)
                  }
                  className="w-4 h-4 text-amber-500 border-gray-300 rounded focus:ring-amber-500 cursor-pointer"
                />
                <span className="text-sm text-gray-700 group-hover:text-gray-900">
                  {t(`enums.language.${option}`)}
                </span>
              </label>
            ))}
          </div>
